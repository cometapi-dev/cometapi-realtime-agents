...
// CometAPI Configuration Types
export interface CometAPIConfiguration {
  apiKey: string;
  baseURL: string;
  realtimeURL?: string;
  model?: string;
...
export interface CometAPIConfigurationValidationResult {
  isValid: boolean;
  errors: string[];
  warnings: string[];
}
...
export interface EnvironmentConfiguration {
  COMETAPIAPI_KEY: string;
  COMETAPI_BASE_URL?: string;
  COMETAPI_REALTIME_URL?: string;
...
export const COMETAPI_BRANDING: BrandingMetadata = {
  serviceName: "CometAPI",
  organizationName: "cometapi-dev",
  repositoryURL: "https://github.com/cometapi-dev/cometapi-realtime-agents",
  documentationURL: "https://docs.cometapi.com",
  supportURL: "https://support.cometapi.com",
};
